...
import { setIsMobileDatePickerOpen, updateFilterByDates } from "../../store/news/filter.reducer";
...
const MobileDatePicker: React.FC<DatePickerProps> = ({ disabled }) => {
    ...
    const handleChange = (dates: [Date | null, Date | null]) => {
        ...
        setEndDate(() => end);
        if (endDate) {
            dispatch(setIsMobileDatePickerOpen(false))
